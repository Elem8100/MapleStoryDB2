...
namespace WzComparerR2.CharaSimControl
{
    public class SkillTooltipRender2 : TooltipRender
    {
        ...
        private Bitmap RenderSkill(out int picH)
        {
            ...
            picH = 35;
            if (!Skill.PreBBSkill)
                GearGraphics.DrawString(g, "[最高等級：" + Skill.MaxLevel + "]", GearGraphics.ItemDetailFont2, 90, 270, ref picH, 16);
            ...
            if (Skill.ReqLevel > 0)
            {
                GearGraphics.DrawString(g, "#c[所需等級：" + Skill.ReqLevel.ToString() + "]#", GearGraphics.ItemDetailFont2, 90, 270, ref picH, 16);
            }
